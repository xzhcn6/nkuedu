...
<script id="id_table_courselist" type="text/html">    
	...
	<tr>
		...
		<td>{{value.credit}}</td>
	    <td><a href="<%=request.getContextPath()%>/admin/showCourseTime?id={{value.id}}&selectId={{value.selectId}}&name={{value.name}}">查看/修改时间</a>
...
<h3>帮助提示</h3>
	<ol>
		...
		<li>“是否开课”指是否在选课手册显示 以及 让学生在选课系统对该课选课退课
		<li>当您关闭某节课时，该课程的上课时间会同时被删除，以免妨碍其他课程安排时间
	</ol>
</div>
